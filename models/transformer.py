...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size,**block_args):
        super().__init__()
        ...
        self.linear_mod1 = nn.Linear(11,1)
        self.linear_mode2 = nn.Linear(hidden_size,11)
    ...
    def forward(self, x, mask=None):
        ...
        x = self.output_net(x)
        x = self.linear_mod1(x).squeeze()
        x = self.linear_mode2(x)
        return x
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, input_dim, num_heads, dim_feedforward, output_size, dropout=0.0):
        """
        Inputs:
